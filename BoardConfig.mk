...
ifeq ($(TARGET_PRODUCT),car_falcon)
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/motorola/falcon/bluetooth_car
else
...
#ifneq ($(filter falcon_fp aosp_falcon_fp,$(TARGET_PRODUCT)),)
#BOARD_HAS_FINGERPRINT_FPC := true
#endif

BOARD_CHARGER_ENABLE_SUSPEND := true

TARGET_RECOVERY_FSTAB = device/motorola/falcon/fstab.falcon

TARGET_RELEASETOOLS_EXTENSIONS := device/motorola/falcon

BOARD_HAL_STATIC_LIBRARIES := libdumpstate.falcon

BOARD_SEPOLICY_DIRS += device/motorola/falcon/sepolicy

ifneq ($(filter falcon_fp aosp_falcon_fp,$(TARGET_PRODUCT)),)
BOARD_SEPOLICY_DIRS += \
       device/motorola/falcon/sepolicy-falcon_fp
